  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-indigo-950 p-4">
      <div className="max-w-3xl w-full text-center space-y-8">
        {/* Bolt.new badge in corner of page */}
        ...
        <div className="space-y-2">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-xl mx-auto mt-4">
            Create fully automated podcasts with AI-generated conversations
            between any personalities. From idea to final audio in minutes!
          </p>
        </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center p-6 z-10">
                ...
                <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
                  Login to start generating amazing AI podcasts
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Choose from multiple realistic AI voices for your podcast
              personalities
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              AI creates natural-sounding dialogue between your chosen
              personalities
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Save your podcasts to your library and share them with others
            </p>
          </div>
        </div>
      </div>
      ...
      <footer className="mt-16 text-center text-sm text-gray-500 dark:text-gray-400">
        <p>
          © {new Date().getFullYear()} PodAI. Powered by Next.js, Supabase, and
          AI.
        </p>
      </footer>
    </main>
